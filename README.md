...
- **AI-Powered Questions** using **Google Gemini (2.0 Flash Lite & 1.5 Flash)** with automatic fallback and rate-limit handling
...
- **AI Integration**: Google Gemini API (Direct REST Integration) with built-in retry logic
